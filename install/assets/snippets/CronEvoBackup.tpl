...
$mode = isset($_GET['mode']) ? $_GET['mode'] : 'dbonly'; //dbonly,light,medium,full
$rootfiles = isset($_GET['rootfiles']) ? $_GET['rootfiles'] : '0'; //1=include root files
$customfiles = isset($_GET['customfiles']) ? $_GET['customfiles'] : '0'; //1=include custom files & folders
$customfold1 = isset($_GET['customfold1']) ? $_GET['customfold1'] : '';
$customfold2 = isset($_GET['customfold2']) ? $_GET['customfold2'] : '';
$customfold3 = isset($_GET['customfold3']) ? $_GET['customfold3'] : '';
$customfold4 = isset($_GET['customfold4']) ? $_GET['customfold4'] : '';
